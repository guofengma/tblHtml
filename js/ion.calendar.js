        ...
        init: function(options){
            ...
            return this.each(function(){
                ...
                var prepareCalendar = function(){
                    ...
                    html += '<div class="ic__prev"><i class="iconfont icon-back"></i></div>';
                    html += '<div class="ic__next"><i class="iconfont icon-right"></i></div>';
                    ...
                    // head year
                    html += '<div class="ic__year"><select class="ic__year-select" disabled>';
                    ...
                    if(settings.sundayFirst) {
                        ...
                        for(i = 0; i < 7; i++) {
                            html += '<td>周' + timeForWork.day(i).format("dd") + '</td>';
                        }
                        html += '</tr></table>';
